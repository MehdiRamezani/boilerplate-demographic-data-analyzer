...
def calculate_demographic_data(print_data=True):
    # # Read data from file
    # df = pd.read_csv(r"/home/runner/boilerplate-demographic-data-analyzer/adult.data.csv")
    ...
    rich_percentage = (df[(df["salary"]== ">50K") & (df["hours-per-week"] == min_work_hours)].value_counts().sum() / df[df["hours-per-week"] == min_work_hours].value_counts().sum() *100 ).round(1)
